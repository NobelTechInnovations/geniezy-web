    ...
    <TopBar isScrolled={isScrolled}  />
          ...
          <div className="flex-1 max-w-2xl mx-8">
            <div className="flex items-center">
              ...
              <input
                ...
                className="flex-1 h-10 px-4 py-2 border-0 focus:outline-none border-t border-b border-gray-300 focus:outline-none"
              />
      ...
      <div className={`w-full bg-white border-t border-gray-200 transition-all duration-300 ${isScrolled ? 'h-0 overflow-hidden opacity-0' : 'h-auto opacity-100'}`}>
        <div className="container mx-auto">
          <nav className="flex overflow-x-auto px-4 py-2 scrollbar-none">
